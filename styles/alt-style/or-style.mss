  ...
  ::case[zoom>=8]{
    ...
    [zoom>=16] { line-width:6.5; }
      ...
      [or_responsibility = "national"] { 
        line-color: mix(#e06d5f, #000000,70);
        line-width: 0;
      ...
      [or_responsibility='provincial'] {
        line-join:round;
        line-width: 0;
        line-color: mix(#eab056, #000000, 80);
        #road { line-cap: round; }
      ...
      [or_responsibility='municipal']{
        line-join:round;
        line-color: mix(#ffff7e, #000000, 70);
        #road { line-cap: round; }
        [zoom>=0] { line-width: 0; }
      ...
      [or_responsibility='barangay']{
        line-join:round;
        line-color: mix(#eaeaea, #000000, 90);
        line-width: 0;
        #road { line-cap: round; }
        [zoom>=12] { line-width:1.5; }
        [zoom>=13] { line-color: mix(#eaeaea, #000000, 70); }
        [zoom>=15] { line-width:4; }
